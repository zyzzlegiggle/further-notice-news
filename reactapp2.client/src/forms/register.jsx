        ...
        <Page>
            ...
            <div className="flex flex-row" >
                ...
                <section className="basis-1/5 ">
                    <div id="toast-success" className={`${successful ? "visible opacity-100 translate-y-0" : "invisible opacity-0 -translate-y-4"} transition-all duration-500 ease-in-out flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`} role="alert">
                        <div className={` ${successful ? "text-green-500 bg-green-100  dark:bg-green-800 dark:text-green-200" : "text-red-500 bg-red-100 dark:text-red-200 dark:bg-red-800"} inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-lg`}>
                            <svg className="w-5 h-5" aria-hidden="true" sxmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d={successful ?
