...
function Article({ articles }) {
                    ...
                    <section className="grid grid-cols-3 gap-8 border-b mb-8 pb-8 pt-8">
                        {(() => {
                            ...
                            for (let j = 1; j <= 3; j++) {
                                if (articles[i + j]) {
                                    sideArticles.push(
                                        <article className={`col-span-1 ${j === 3 ? '' : 'border-r'} px-4 static`} >
                                            <h1 className="text-xl font-semibold">
                                                {articles[i + j]["title"]}

                                            </h1>
                                            <span>
                                                <ArticleMenu article={articles[i + j]} bookmarked={bookmarked} />
                                            </span>
                                            <p>{articles[i + j]["description"]}</p>
                                        </article>
                                    );
    ...
    return (
        <>
            {articleRows.length ? articleRows : <></>}
        </>
